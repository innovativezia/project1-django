...
def read_data(user_id=None, email=None)
	...
	with open(filename, "r") as csvfile:
		...
		if unknown_user_id is not None:
			return "user_id {user_id} not found".format(user_id=user_id)
...
#append_data("data.csv", "Abdullah", "amna@gmail.com", 1243.67)
...
#edit_data(8, 345.2, "")
edit_data(email='amna@gmail.com', amount=99.99, sent='')